...
**QueryCraft** is a personal learning project I built to get hands-on experience with React.js and Redux Toolkit. It currently serves as a Recipe Display App that fetches data from an external API and allows users to search, filter, and sort through the recipes smoothly.

My main focus while building this was to understand how to manage global state, implement client-side authentication, and create a clean, responsive UI using Tailwind CSS.

### ✨ What I Learned / Features Built
...
- **Styling:** Tailwind CSS, Material-UI (for loaders)
- **API Calls:** Axios
